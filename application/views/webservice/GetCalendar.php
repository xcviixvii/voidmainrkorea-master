<?php
function search_calendar($year,$month,$dateArray) {
     $ci =& get_instance();
  // Create array containing abbreviations of days of week.
     ...
     $datelist = datebetween('2019-07-05','2019-08-29');
...
<?php
     ...
     echo search_calendar($_POST['nowYear'],$_POST['nowMonth'],$dateComponents);
?>