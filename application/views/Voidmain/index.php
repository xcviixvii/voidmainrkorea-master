...
?>
		...
		<div class="bottom-body">
			<div id="member-wrapper">
				<header id="member-header">
					...
					<h1><img src="<?=base_url()?>Images/Login/login_logo_title.gif" alt="Logo"></h1>
					<section class="tell">
    ...
    <footer id="footer">
	<?php renderview('HomePage/Templates/tmpfooter') ?>
	</footer>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#btnLogin').click(function() {
                ...
                $('#frmLogin').attr('action', '<?=base_url()?>jrgapi/MasterPage').submit();
