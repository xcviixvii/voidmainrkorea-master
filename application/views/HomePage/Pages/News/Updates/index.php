<title><?=((count($GSet) > 0) ? "".$GSet[0]['ServerTitle']."":"")?> | Update</title>
<body  class="sub-body">
    <div class="in-body1">
    ...
    <section class="page-history">
		...
		NEWS
		<img src="<?=base_url()?>Images/ico_navi.gif" alt="">
		<span class="page-history-select">UPDATE</span>
	</section>
	<h3 class="sub-title">
		<img src="<?=base_url()?>Images/SubTitle/News/update_sub_title.gif" alt="Notice">
	</h3>
