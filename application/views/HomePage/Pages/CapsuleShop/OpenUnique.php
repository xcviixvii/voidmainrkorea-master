...
<embed src="/CapsuleShop/Sound/Fanfare.wav" autostart="true" hidden="true" loop="false" />
<div class="result">
<p class="win">Congratulations! You have won a Lucky Item!</p>
<p class="item_name"><?=$caps[0]['ItemName']?></p>
<div class="win_bg">
<img id="capsule-item<?=$item[0]['ItemNum']?>" class="tooltip" src="<?=base_url()?>Uploadfiles/ItemShop/<?=$caps[0]['ItemSS']?>" alt="<?=$caps[0]['ItemName']?>" width="80" height="80" />
</div>
</div>
