<title><?=((count($GSet) > 0) ? "".$GSet[0]['ServerTitle']."":"")?> | Item Shop</title>
<body  class="sub-body">
<div id="dialog" style='display:none; text-align:center; overflow:hidden;' >
	...
	<h3 class="sub-title">
		<img src="<?=base_url()?>Images/SubTitle/Itemshop/itemshop_sub_title.gif" alt="ItemShop">
	</h3>
    ...
    $i = 1;
    echo '<ul>';
    foreach (array_chunk($ItemShop, 4, true) as $array) {
