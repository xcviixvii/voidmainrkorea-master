...
<?php
if(!empty($login_url)) {
	echo '<a href="'.$login_url.'"><center>Login With FB</center></a>';
}else{
...
<div class="wrapper">
    ...
    echo '<p class="image"><img src="" alt="" width="300" height="220"/></p>';
    ...
    echo '<p><b>Logout from <a href="'.base_url().'authentication/logout">'.$userData['oauth_provider'].'</a></b></p>';
    echo '</div>';
    ?>
</div>
<?php } ?>
